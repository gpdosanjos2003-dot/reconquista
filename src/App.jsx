    ...
    <div style={S.page} ref={topRef}>
      ...
      <div style={{ padding: "32px 20px" }}>
        ...
        <div style={{ marginBottom: 28 }}>
          ...
          {/* CTA principal */}
          <button style={{ ...S.btnRed, marginBottom: 12, fontSize: 20, padding: "22px 24px" }}>
            🔥 QUERO MEU PROTOCOLO POR R$37
          </button>
          <button style={{ ...S.btn, fontSize: 14, padding: "14px 24px", marginBottom: 20 }}>
          ...
          <div style={{ marginTop: 32, textAlign: "center" }}>
            ...
            <button style={{ ...S.btnRed, fontSize: 18, padding: "20px 24px", marginBottom: 12 }}>
